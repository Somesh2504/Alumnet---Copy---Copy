...
const Community = () => {
  ...
  const fetchMessages = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`http://localhost:5000/api/community/messages/${groupType}`, {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        const response = await axios.post('http://localhost:5000/api/community/upload-media', 
          formData, {
            withCredentials: true,
        ...
        // Send text message
        const response = await axios.post('http://localhost:5000/api/community/messages', {
          content: newMessage,
          groupType,
          replyTo: replyTo?._id
        }, {
  ...
  const toggleLike = async (messageId) => {
    try {
      const response = await axios.put(`http://localhost:5000/api/community/messages/${messageId}/like`, {}, {
        withCredentials: true
      });
  ...
  const replyToMessage = async (messageId, content) => {
    ...
    try {
      const response = await axios.post(`http://localhost:5000/api/community/messages/${messageId}/reply`, {
        content
      }, {
        withCredentials: true
      });
  ...
  const editMessage = async (messageId, content) => {
    try {
      const response = await axios.put(`http://localhost:5000/api/community/messages/${messageId}`, {
        content
      }, {
        withCredentials: true
      });
  ...
  const deleteMessage = async (messageId) => {
    ...
    try {
      const response = await axios.delete(`http://localhost:5000/api/community/messages/${messageId}`, {
        withCredentials: true
      });
